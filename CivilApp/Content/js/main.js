...
Modernizr.load({
  ...
  yep: ['~/Content/plugins/fix/ios-fix/ios-orientationchange-fix.js', '~/Content/plugins/fix/touch-punch/jquery.ui.touch-punch.min.js']
});
...
$(document).ready(function(){ 	
	...
	if(supr_Options.rtl) {
		...
		$('#bootstrap').attr('href', '~/Content/css/bootstrap/bootstrap.rtl.min.css');
		$('#bootstrap-responsive').attr('href', '~/Content/css/bootstrap/bootstrap-responsive.rtl.min.css');
		$('body').addClass('rtl');
